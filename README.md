...
A good place to start looking at my work is to see my Infrastructure file (https://github.com/carlos-castillo-a/carlos-castillo-a/blob/main/Diagrams/Infrastructure-Backbone.md) that contains a diagrams of my base infrastructue that is used throughout current and future projects (with more to be added).
...
### Contact Me
  Interested in my work? Feel free to reach out at carlos@castillo-a.com
